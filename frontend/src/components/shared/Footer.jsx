      ...
      <div className="max-w-7xl mx-auto px-8">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0">
            <h2 className="text-xl font-bold text-[#0F172A] mb-2">Career<span className='text-[#3B82F6]'>Hunt</span></h2>
            <p className="text-sm text-[#64748B]">© 2024 CareerHunt. All rights reserved.</p>
          </div>
          
          <div className="flex space-x-6 mt-4 md:mt-0">
            <a href="https://facebook.com" className="text-[#64748B] hover:text-[#3B82F6] transition-colors" aria-label="Facebook">
            ...
            <a href="https://twitter.com" className="text-[#64748B] hover:text-[#3B82F6] transition-colors" aria-label="Twitter">
            ...
            <a href="https://linkedin.com" className="text-[#64748B] hover:text-[#3B82F6] transition-colors" aria-label="LinkedIn">
